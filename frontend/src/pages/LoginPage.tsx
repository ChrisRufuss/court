    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-xl shadow-xl w-full max-w-md p-8 space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-serif font-bold text-slate-900">Advocate Sign In</h1>
          <p className="text-xs text-slate-500">Access LexAnalyze Legal Case Intelligence Workspace</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-slate-700 mb-1">Advocate Email Address</label>
